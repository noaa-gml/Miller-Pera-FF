; pro ff_country_new2024b, dev=dev, season=season
...
;edgarfile = 'fracarr_' + strtrim(yr1, 2) + '_' + strtrim(yr3, 2) + '.sav'
restore, './processed_inputs/fracarr_1993_2023.sav' ; global EDGAR pixel fractions (at 1x1) from yr1 through yr3
;restore, './processed_inputs/john_fracarr_1992_2024.sav'
...
save, fluxarr3, filename = './outputs/fluxarr3.sav'
...
for i = 12 * 8, 9 * 12 - 1 do begin
  file = './outputs/co2ff.country_cdiac_bp.seas' + season + seas2 + '.1x1.hdf' + chardate(idate2, cut = 4)
