#!/usr/bin/env python3
"""ingest.py — Ingest and process raw input data for the Miller-Pera FF pipeline.

Reads CDIAC, EI, USGS, and EDGAR source files and writes processed CSVs and
NetCDF to processed_inputs/ for consumption by ff_country.py.
...
def main() -> None:
    ...
    # ff_country.py for flaring-sector extrapolation ratios.
